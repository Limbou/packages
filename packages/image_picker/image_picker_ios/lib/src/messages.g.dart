...
class ImagePickerApi {
  ...
  Future<List<String?>> pickMultiImage(MaxSize arg_maxSize, int? arg_imageQuality, bool arg_requestFullMetadata) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        ...
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_maxSize, arg_imageQuality, arg_requestFullMetadata]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
  ...
  Future<String?> pickVideo(SourceSpecification arg_source, int? arg_maxDurationSeconds, bool arg_requestFullMetadata) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.ImagePickerApi.pickVideo', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_source, arg_maxDurationSeconds, arg_requestFullMetadata]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
